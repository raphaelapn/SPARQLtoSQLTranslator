...
public class ExprTranslator implements ExprVisitor {
    ...
    public void visit(ExprFunction1 func) {
        ...
        //bound(?x) equivalent x is not NULL
    ...
    public void visit(NodeValue nv) {
    	System.out.println(nv.asString());
    	System.out.println(nv.getClass().getName());
    	try {
    		//caso a condition seja um integer
    		stack.push(""+Integer.parseInt(FmtUtils.stringForNode(nv.asNode())));
    	} catch (NumberFormatException e) {
    		//caso a condition seja um decimal
    		if(nv.getClass().getName().equals("com.hp.hpl.jena.sparql.expr.nodevalue.NodeValueDecimal")){
    			stack.push(""+Double.parseDouble(FmtUtils.stringForNode(nv.asNode())));
    		}
    		//caso a condition seja um string
    		else{
